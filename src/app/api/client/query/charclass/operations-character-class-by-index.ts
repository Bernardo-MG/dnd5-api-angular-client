...
import { OperationsCharacterClassLevel } from "./operations-character-class-level";

export class OperationsCharacterClassByIndex implements CharacterClassByIndex {
  ...
  public levels(): CharacterClassLevel {
    return new OperationsCharacterClassLevel(this.getOperations, this.index);
  }
